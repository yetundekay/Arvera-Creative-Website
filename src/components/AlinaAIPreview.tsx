...
import svgPaths from "../imports/svg-el4itadpi5";
  ...
  return (
    <div className="absolute h-[417.643px] left-[169.51px] overflow-clip top-[93.78px] w-[668.229px]">
      <div className="absolute h-[417px] left-[-0.51px] top-[0.21px] w-[669px]" data-name="image 43">
        <img alt="Alina AI Dashboard Dark Mode" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage43} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[627.432px] left-[calc(50%-149.872px)] overflow-clip top-[calc(50%+66.716px)] translate-x-[-50%] translate-y-[-50%] w-[1007.26px]">
      <div className="absolute left-0 size-[1007.26px] top-[-189.91px]" data-name="laptop_realistic 2">
        <img alt="Laptop mockup" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgLaptopRealistic2} />
      </div>
      <Frame />
    </div>
  );
  ...
  return (
    <div className="absolute h-[331.039px] left-[36.7px] overflow-clip top-[40.85px] w-[529.662px]">
      <div className="absolute h-[331px] left-[-2.71px] top-[0.15px] w-[536px]" data-name="image 44">
        <img alt="Alina AI Dashboard Light Mode" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage44} />
      </div>
    </div>
  );
}
...
export const AlinaAIPreview: React.FC = () => {
  return (
